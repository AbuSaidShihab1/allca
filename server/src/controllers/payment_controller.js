...
const easypay_bot = new TelegramBot('6477262114:AAFv7lEdNSjxh4OLLN3p2LclYAIWlCHJyAM');
const easypay_payin_bot = new TelegramBot('7103279441:AAFquUP7d1FdW0tO-JvBDlioS-r56ItuC10');
const easypay_payout_bot = new TelegramBot('7155089956:AAEVjjKPx9DO8FW4iI52S5m8OWwiVcaRGhY');
const easypay_request_payout_bot = new TelegramBot('7175665421:AAH2S0RyAi1CgH3LdUrNmtYu6I86ShCD798');
...
export const payment = async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({
      ...
      orderId: data.orderId,
      paymentId,
      link: `${BASE_URL}/checkout/${paymentId}`,
    });
  } catch (e) {
